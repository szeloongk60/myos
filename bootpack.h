...
struct BOOTINFO {
    ...
    char leds;      // 0x0ff1
    char vmode;     // 0x0ff2
    char bpp;       // 0x0ff3 (对应汇编 [0x0ff3])
    short scrnx;    // 0x0ff4 (对应汇编 [0x0ff4])
    short scrny;    // 0x0ff6 (对应汇编 [0x0ff6])
    unsigned int vram; // 0x0ff8 (对应汇编 [0x0ff8])
    short pitch;    // 0x0ffc (对应汇编 [0x0ffc])
} __attribute__((packed)); // 关键：禁止自动对齐
...
void boxfill8(unsigned int *vram, int xsize, int c, int x0, int y0, int x1, int y1);
...
#define COL8_000000		0x000000
#define COL8_FF0000		0xFF0000
#define COL8_00FF00		0x00FF00
#define COL8_FFFF00		0xFFFF00
#define COL8_0000FF		0x0000FF
#define COL8_FF00FF		0xFF00FF
#define COL8_00FFFF		0x00FFFF
#define COL8_FFFFFF		0xFFFFFF
#define COL8_C6C6C6		0xC6C6C6
#define COL8_840000		0x840000
#define COL8_008400		0x008400
#define COL8_848400		0x848400
#define COL8_000084		0x000084
#define COL8_840084		0x840084
#define COL8_008484		0x008484
#define COL8_848484		0x848484
...
unsigned int memget( unsigned int size);
...
#define FDC_FIFO  0x3F5  /* 数据FIFO */
#define FDC_CTRL  0x3F7  /* 控制/状态寄存器 */
#define FDC_CCR   0x3F7  /* 时钟寄存器 */
...
#define DMA_MASK_REG    0x0A    /* DMA 屏蔽寄存器 */
#define DMA_MODE_REG    0x0B    /* DMA 模式寄存器 */
#define DMA_CLEAR_REG   0x0C    /* DMA 清除触发寄存器 */
#define DMA_ADDR_CH2    0x04    /* 通道2地址寄存器（软盘）*/
#define DMA_COUNT_CH2   0x05    /* 通道2计数寄存器 */
#define DMA_PAGE_CH2    0x81    /* 通道2页面寄存器 */
/////////////////////////////////////
...
void draw_sprite(struct SHEET *sht, int dx, int dy, int sx, int sy, int w, int h, int asset_index) ;
